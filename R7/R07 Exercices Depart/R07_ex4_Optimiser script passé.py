...
# Au cours 4, nous avons fait un exercice qui devait lire une liste d'étudtants et qui devait créer un dossier pour chaque étudiant.
# On veut maintenant découper ce script en fonctions pour le rendre plus compréhensible.
...
#  On pourrait découper ce script en plusieurs fonctions pour que ce qui est fait soit plus clair 
