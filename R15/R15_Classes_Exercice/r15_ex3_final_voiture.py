class Voiture:
    def __init__(self,modele,marque,annee,couleur,kilometrage,prix,etat='neuf') -> None:
        self.modele = modele
        self.marque = marque
        self.annee = annee
...
voiture_2 = Voiture(modele='E-Class',marque='Mercedes-Benz',annee='2023',couleur='grise',kilometrage='23000',prix=54600,etat='irréprochable')
