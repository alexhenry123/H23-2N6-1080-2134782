...
# Vous devez écrire le code pour produire un nouveau fichier Ex2_Total_Janvier.txt qui contiendra les données suivantes:
#        MOIS     TOTAL 
#       -Janvier    475
#       
...
# 
#  dans ces deux with:
#       Commencez par écrire dans le fichier Ex2_Total_Janvier.txt la ligne d'entête:   "    MOIS    TOTAL" 
...
#       Écrivez la ligne_a_imprimez dans le fichier Ex2_TotalJanvier.txt         
